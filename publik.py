...
#client = LineClient()
client = LineClient(id='pinksweetblack@gmail.com', passwd='smokers69')
...
admin=["u982229a095e39f65460367dd891fe060"]
                    ...
                    if msg.contentType == 0:
                        if msg.toType == 0 or msg.toType == 2:
                            ...
                            if text.lower() == 'creator':
                                cret = "u982229a095e39f65460367dd891fe060"
                                client.sendMessage(receiver, None, contentMetadata={'mid': cret}, contentType=13)
                                client.sendText(receiver, '「Auto respon tag」')
                                client.tag(receiver, cret)
                                print ("[COMMAND] MENTION ME")
                            if text.lower() == 'tag':
       ...
       #                         if len(string.decode('utf-8')) <= 10000000000:
        #                            profile = client.getProfile()
         #                           profile.displayName = string
          #                          client.updateProfile(profile)
           #                         client.sendText(msg.to,"Changed " + string + "")
            #                        
...
#==============================================================================#
                                ...
                                client.sendText(msg.to, t1 + txt + t2)
                                ...
                                client.sendText(msg.to,"**FROM ID**\n" + "" + kata + "\n**TO ENGLISH**\n" + "" + result + "\n**SUKSES**")
                                ...
                                result = page[page.find(cari_hasil)+len(cari_hasil):]
                                result = result.split("<")[0]
                                client.sendText(msg.to,"**FROM EN**\n" + "" + kata + "\n**TO ID**\n" + "" + result + "\n**SUKSES**")
                                ...
                                result = page[page.find(cari_hasil)+len(cari_hasil):]
                                result = result.split("<")[0]
                                client.sendText(msg.to,"----FROM JP----\n" + "" + kata + "\n----TO ID----\n" + "" + result + "\n------SUKSES-----")
                                ...
                                result = page[page.find(cari_hasil)+len(cari_hasil):]
                                result = result.split("<")[0]
                                client.sendText(msg.to,"----FROM TH----\n" + "" + kata + "\n----TO ID----\n" + "" + result + "\n------SUKSES-----")
                            elif "Id@jp" in msg.text:
                                bahasa_awal = 'id'
                                bahasa_tujuan = 'ja'
                                kata = msg.text.replace("Id@jp ","")
                                ...
                                result = page[page.find(cari_hasil)+len(cari_hasil):]
                                result = result.split("<")[0]
                                client.sendText(msg.to,"----FROM AR----\n" + "" + kata + "\n----TO ID----\n" + "" + result + "\n------SUKSES-----")
                                ...
                                result = page[page.find(cari_hasil)+len(cari_hasil):]
                                result = result.split("<")[0]
                                client.sendText(msg.to,"----FROM KO----\n" + "" + kata + "\n----TO ID----\n" + "" + result + "\n------SUKSES-----")
...
#============================================================#KICKER FINISHED#=========================================================#
                              ...
                              if sender in admin:
                                ...
                                gid = client.getGroupIdsJoined()
                                for i in gid:
                                    client.sendText(i,"╭═══╬GROUPBROADCAST╬═══╮\n\n"+bc+"\n\nContact Me :\n line.me/ti/p/~_hurt")
#                                    client.sendText(msg.to,"Done")
 #                               else:
  #                                  client.sendText(msg.to,"Khusus Admin")
...
#============================================================#MODE / RESTART#=========================================================#
                              ...
                              if sender in admin:
                                client.sendText(receiver, '「Bot rebooting」')
                                print ("BOT RESTART")
                                restart_program()
                except Exception as e:
